require.config({
    shim: {
        'bootstrap': ['jquery', 'axios', 'vue'],
        'sparkline': ['jquery', 'axios', 'vue'],
        'jscookie': ['jquery', 'axios', 'vue'],
        'tablesorter': ['jquery', 'axios', 'vue'],
        'vector-map': ['jquery', 'axios', 'vue'],
        'vector-map-de': ['vector-map', 'jquery', 'axios', 'vue'],
        'vector-map-world': ['vector-map', 'jquery', 'axios', 'vue'],
        'core': ['bootstrap', 'jquery', 'axios', 'vue'],
    },
    paths: {
        'core': '/static/js/core',
        'jquery': '/static/js/vendors/jquery-3.2.1.min',
        'axios': '/static/js/vendors/axios',
        'vue': '/static/js/vendors/vue',
        'bootstrap': '/static/js/vendors/bootstrap.bundle.min',
        'sparkline': '/static/js/vendors/jquery.sparkline.min',
        'jscookie': '/static/js/vendors/js-cookie-2.2.0',

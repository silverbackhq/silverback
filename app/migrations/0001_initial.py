# Generated by Django 2.1.8 on 2019-07-09 23:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[
                    ...
                    ('update', 'UPDATE'),
                    ('resolved', 'RESOLVED')
                ], default='update', max_length=50, verbose_name='Status')),
        ...
        migrations.CreateModel(
            name='IncidentUpdateNotification',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[
                    ('pending', 'PENDING'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[
                    ...
                    ('datadog', 'DATADOG'),
                    ('pingdom', 'PINGDOM')
                ], default='newrelic', max_length=50, verbose_name='Source')),
        ...
        migrations.AddField(
            model_name='incidentupdatenotification',
            name='subscriber',
            field=models.ForeignKey(
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
